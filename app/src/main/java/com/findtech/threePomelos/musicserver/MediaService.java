...
public class MediaService extends Service {
    ...
    public static final String PLAYLIST_ITEM_MOVED = "com.findtech.three.mmoved";
    ...
    public static final String UPDATE_LOCKSCREEN = "com.findtech.three.updatelockscreen";
    ...
    public static final String TRY_GET_TRACKINFO = "com.findtech.three.gettrackinfo";
...
//                startActivity(lockscreen);
    ...
    private void addToPlayList(final long[] list, int position) {
        ...
        L.e("SixItem",mPlaylist.size()+""+mPlayPos);
    ...
    private void updateCursor(final long trackId) {
        L.e("SixItem", "updateCursor"+mPlayPos);
...
//                    mPlayer.setDataSource(url);
    ...
    private void openCurrentAndMaybeNext(final boolean play, final boolean openNext) {
        synchronized (this) {
            ...
            L.e("SixItem", id +"openCurrentAndMaybeNext"+ mPlayPos );
            updateCursor(id);
            //getLrc(id);
            ...
            if (!mPlaylistInfo.get(id).islocal) {
                if (mRequestUrl != null) {
                    mRequestUrl.stop();
                    L.e("SixItem",id +"=="+ play +mPlaylistInfo.get(id).lrc+mPlaylistInfo.get(id).musicName);
...
//        }
        if (what.equals(META_CHANGED)) {
            ...
            saveQueue(true);
            L.e("SixItem","notifyChange=="+isPlaying()+mPlayPos);
            if (isPlaying()) {
...
//        } else
    ...
    public void open(final HashMap<Long, MusicInfo> infos, final long[] list, final int position) {
        synchronized (this) {
            L.e("SixItem",mPlaylist.size() +"open"+mPlayPos);
            mPlaylistInfo = infos;
            ...
            if (newlist) {
                //添加新的播放队列
                L.e("SixItem",newlist +"open"+mPlayPos);
    ...
    private static final class MultiPlayer implements MediaPlayer.OnErrorListener,
        ...
        public void setNextDataSource(final String path) {
            L.e("SixItem", "setNextDataSource");
            mNextMediaPath = null;
            mIsNextInitialized = false;
            try {
                mCurrentMediaPlayer.setNextMediaPlayer(null);
            } catch (IllegalArgumentException e) {
                L.e("SixItem", "Next media player is current one, continuing");
            } catch (IllegalStateException e) {
                L.e("SixItem", "Media player not initialized!");
                return;
            }
            ...
            if (setNextDataSourceImpl(mNextMediaPlayer, path)) {
                L.e("setNextDataSourceImpl","setNextDataSourceImpl");
                mNextMediaPath = path;
